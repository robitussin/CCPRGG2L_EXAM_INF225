...
import java.util.Scanner;
    public static void main(String[] args) {
        ...
        pattern = Pattern.compile("\w+@gmail.com");
        ...
        // Provide regex pattern
        pattern = Pattern.compile("http://+\w+.com/+\w");
        ...
        // Provide regex pattern
        pattern = Pattern
                .compile(".+\\.txt",".+\\.pptx",".+\\.xlsx",".+\\.docx",".+\\.py",".+\\.java","+\\.cpp");
        ...
        // Provide the regex pattern
        tweet = tweet.replaceAll("https?://\\S+", "http://\\S+");
